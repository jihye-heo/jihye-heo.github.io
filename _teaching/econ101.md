...
- Revenue: $10 per unit | Production Cost: $3 per unit
- Electricity Bill: $30 (base) + α × (production), where α depends on grid strain:
  - Low strain (avg ≤ 50): α = 0.15
  - Moderate strain (avg 51-75): α = 0.25
  - High strain (avg ≥ 76): α = 0.35
- **Household Impact:** Local households (using 30 units) face the same α rate, creating visible externality effects
**Phase Structure:**
...
- **Final Summary:** Aggregate analysis across all rounds with policy discussion
**Two Roles Available:**
